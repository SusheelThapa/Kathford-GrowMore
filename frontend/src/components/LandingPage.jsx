              ...
              <ul className="flex space-x-4 text-xl">
                ...
                <li
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.scrollTo({
                      top: document.querySelector("#landing-features")
                        .offsetTop,
                      behavior: "smooth",
                    });
                  }}
                ...
                <li
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    window.scrollTo({
                      top: document.querySelector("#landing-contactUs")
                        .offsetTop,
                      behavior: "smooth",
                    });
                  }}
          ...
          <div className="container mx-auto flex flex-row">
            <div className="text-white bg-opacity-90 p-8 rounded w-3/4">
              ...
              <p className=" text-white text-justify">
                Welcome to GrowMore – where innovation meets investment. We're
                dedicated to cultivating transformative business ideas and
                fostering connections between entrepreneurs and investors. Our
                platform is more than an idea marketplace; it's a dynamic
                ecosystem with an intelligent recommender system. This
                technology analyzes user preferences and market dynamics to
                provide personalized recommendations. Entrepreneurs find
                investors who resonate with their vision, and investors discover
                curated opportunities aligned with their goals. Join us in
          ...
          <div className="container mx-auto">
            <div className="text-white bg-opacity-90 p-8 rounded shadow-md">
              ...
              <p className=" text-white text-justify">
                ...
                adipiscing elit. Nullam eget tortor nec purus bibendum ultricies
                sit amet vitae justo. Mauris facilisis risus ac massa fermentum,
                vel consectetur lacus bibendum.
              </p>
              <p className="text-white mt-4 text-justify">
                Our mission is to provide valuable information and services to
                our users. Lorem ipsum dolor sit amet, consectetur adipiscing
            ...
            <section className="bg-white dark:bg-black">
              <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                  ...
                  <button
                    type="submit"
                    className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 bg-blue-600"
                  >
                    Send message
                  </button>
                </form>
